...
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'RVXfZajHlH4AukuB'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/project4.css"); // Project stylesheet file name
...
$PROJECT_ID = "{67EA411E-68CD-4417-BBD3-7C9FD30B9B35}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "silog", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "USER_TABLE", "`tb_user`");
