...
// Create page object
$trx_pembelian_detail_edit = new trx_pembelian_detail_edit();

// Run the page
$trx_pembelian_detail_edit->run();
...
$trx_pembelian_detail_edit->Page_Render();
?>
...
var ftrx_pembelian_detailedit = currentForm = new ew.Form("ftrx_pembelian_detailedit", "edit");

// Validate form
ftrx_pembelian_detailedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($trx_pembelian_detail_edit->no->Required) { ?>
			elm = this.getElements("x" + infix + "_no");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $trx_pembelian_detail->no->caption(), $trx_pembelian_detail->no->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($trx_pembelian_detail_edit->kode_pembelian->Required) { ?>
		...
		<?php if ($trx_pembelian_detail_edit->nama_barang->Required) { ?>
		...
		<?php } ?>
		<?php if ($trx_pembelian_detail_edit->qty->Required) { ?>
		...
		<?php if ($trx_pembelian_detail_edit->kd_satuan->Required) { ?>
...
ftrx_pembelian_detailedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ftrx_pembelian_detailedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ftrx_pembelian_detailedit.lists["x_nama_barang"] = <?php echo $trx_pembelian_detail_edit->nama_barang->Lookup->toClientList() ?>;
ftrx_pembelian_detailedit.lists["x_nama_barang"].options = <?php echo JsonEncode($trx_pembelian_detail_edit->nama_barang->lookupOptions()) ?>;
ftrx_pembelian_detailedit.autoSuggests["x_nama_barang"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
ftrx_pembelian_detailedit.lists["x_kd_satuan"] = <?php echo $trx_pembelian_detail_edit->kd_satuan->Lookup->toClientList() ?>;
ftrx_pembelian_detailedit.lists["x_kd_satuan"].options = <?php echo JsonEncode($trx_pembelian_detail_edit->kd_satuan->lookupOptions()) ?>;
ftrx_pembelian_detailedit.autoSuggests["x_kd_satuan"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
<?php $trx_pembelian_detail_edit->showPageHeader(); ?>
<?php
$trx_pembelian_detail_edit->showMessage();
?>
<form name="ftrx_pembelian_detailedit" id="ftrx_pembelian_detailedit" class="<?php echo $trx_pembelian_detail_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($trx_pembelian_detail_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $trx_pembelian_detail_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="trx_pembelian_detail">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$trx_pembelian_detail_edit->IsModal ?>">
...
<?php if ($trx_pembelian_detail->no->Visible) { // no ?>
	<div id="r_no" class="form-group row">
		<label id="elh_trx_pembelian_detail_no" class="<?php echo $trx_pembelian_detail_edit->LeftColumnClass ?>"><?php echo $trx_pembelian_detail->no->caption() ?><?php echo ($trx_pembelian_detail->no->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $trx_pembelian_detail_edit->RightColumnClass ?>"><div<?php echo $trx_pembelian_detail->no->cellAttributes() ?>>
<span id="el_trx_pembelian_detail_no">
<span<?php echo $trx_pembelian_detail->no->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($trx_pembelian_detail->no->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="trx_pembelian_detail" data-field="x_no" name="x_no" id="x_no" value="<?php echo HtmlEncode($trx_pembelian_detail->no->CurrentValue) ?>">
<?php echo $trx_pembelian_detail->no->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($trx_pembelian_detail->kode_pembelian->Visible) { // kode_pembelian ?>
	<div id="r_kode_pembelian" class="form-group row">
		<label id="elh_trx_pembelian_detail_kode_pembelian" for="x_kode_pembelian" class="<?php echo $trx_pembelian_detail_edit->LeftColumnClass ?>"><?php echo $trx_pembelian_detail->kode_pembelian->caption() ?><?php echo ($trx_pembelian_detail->kode_pembelian->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $trx_pembelian_detail_edit->RightColumnClass ?>"><div<?php echo $trx_pembelian_detail->kode_pembelian->cellAttributes() ?>>
...
<?php if ($trx_pembelian_detail->nama_barang->Visible) { // nama_barang ?>
	<div id="r_nama_barang" class="form-group row">
		<label id="elh_trx_pembelian_detail_nama_barang" class="<?php echo $trx_pembelian_detail_edit->LeftColumnClass ?>"><?php echo $trx_pembelian_detail->nama_barang->caption() ?><?php echo ($trx_pembelian_detail->nama_barang->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $trx_pembelian_detail_edit->RightColumnClass ?>"><div<?php echo $trx_pembelian_detail->nama_barang->cellAttributes() ?>>
...
<script>
ftrx_pembelian_detailedit.createAutoSuggest({"id":"x_nama_barang","forceSelect":false});
</script>
...
<?php if ($trx_pembelian_detail->qty->Visible) { // qty ?>
	<div id="r_qty" class="form-group row">
		<label id="elh_trx_pembelian_detail_qty" for="x_qty" class="<?php echo $trx_pembelian_detail_edit->LeftColumnClass ?>"><?php echo $trx_pembelian_detail->qty->caption() ?><?php echo ($trx_pembelian_detail->qty->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $trx_pembelian_detail_edit->RightColumnClass ?>"><div<?php echo $trx_pembelian_detail->qty->cellAttributes() ?>>
...
<?php if ($trx_pembelian_detail->kd_satuan->Visible) { // kd_satuan ?>
	<div id="r_kd_satuan" class="form-group row">
		<label id="elh_trx_pembelian_detail_kd_satuan" class="<?php echo $trx_pembelian_detail_edit->LeftColumnClass ?>"><?php echo $trx_pembelian_detail->kd_satuan->caption() ?><?php echo ($trx_pembelian_detail->kd_satuan->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $trx_pembelian_detail_edit->RightColumnClass ?>"><div<?php echo $trx_pembelian_detail->kd_satuan->cellAttributes() ?>>
...
<script>
ftrx_pembelian_detailedit.createAutoSuggest({"id":"x_kd_satuan","forceSelect":false});
</script>
...
<?php if (!$trx_pembelian_detail_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $trx_pembelian_detail_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $trx_pembelian_detail_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$trx_pembelian_detail_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$trx_pembelian_detail_edit->terminate();
?>