...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>PNC.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>PNC.ico">
...
<div class="wrapper ew-layout">
	...
	<aside class="<?php echo $SIDEBAR_CLASS ?>">
		...
		<a href="#" class="brand-link">
			<span class="brand-text">INDILOGS PNC</span>
		</a>
		<!-- Sidebar -->
		<div class="sidebar">
			<!-- Sidebar Menu -->
