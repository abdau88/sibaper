...
<div class="card">
	<div class="card-body">
	<p class="login-box-msg"><?php echo $Language->phrase("Masukkan username dan password") ?></p>
	...
	<div class="form-group row">
		<div class="custom-control custom-checkbox">
			...
			<label class="custom-control-label" for="rememberme"><?php echo $Language->Phrase("Ingat saya") ?></label>
		</div>
	</div>
