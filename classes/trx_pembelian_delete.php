 ...
 * Page class
 */
class trx_pembelian_delete extends trx_pembelian
{
	...
	// Page object name
	public $PageObjName = "trx_pembelian_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("trx_pembelianlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("trx_pembelianlist.php"); // Return to list
			}
		}
	}
