 ...
 * Page class
 */
class trx_penerimaan_delete extends trx_penerimaan
{
	...
	// Page object name
	public $PageObjName = "trx_penerimaan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("trx_penerimaanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("trx_penerimaanlist.php"); // Return to list
			}
		}
	}
