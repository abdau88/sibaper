 ...
 * Page class
 */
class tb_satuan_edit extends tb_satuan
{
	...
	// Page object name
	public $PageObjName = "tb_satuan_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_kd_satuan")) {
				$this->kd_satuan->setFormValue($CurrentForm->getValue("x_kd_satuan"));
			}
		} else {
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("tb_satuanlist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "tb_satuanlist.php")
