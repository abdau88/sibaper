...
/**
 * Table class for v_stok
 */
class v_stok extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_stok';
		$this->TableName = 'v_stok';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_stok`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// kode_barang
		$this->kode_barang = new DbField('v_stok', 'v_stok', 'x_kode_barang', 'kode_barang', '`kode_barang`', '`kode_barang`', 200, -1, FALSE, '`kode_barang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_barang
		$this->nama_barang = new DbField('v_stok', 'v_stok', 'x_nama_barang', 'nama_barang', '`nama_barang`', '`nama_barang`', 200, -1, FALSE, '`nama_barang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_barang->Sortable = TRUE; // Allow sort
		$this->fields['nama_barang'] = &$this->nama_barang;

		// nama_kategori
		$this->nama_kategori = new DbField('v_stok', 'v_stok', 'x_nama_kategori', 'nama_kategori', '`nama_kategori`', '`nama_kategori`', 200, -1, FALSE, '`nama_kategori`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_kategori->Sortable = TRUE; // Allow sort
		$this->fields['nama_kategori'] = &$this->nama_kategori;

		// nama_satuan
		$this->nama_satuan = new DbField('v_stok', 'v_stok', 'x_nama_satuan', 'nama_satuan', '`nama_satuan`', '`nama_satuan`', 200, -1, FALSE, '`nama_satuan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_satuan->Sortable = TRUE; // Allow sort
		$this->fields['nama_satuan'] = &$this->nama_satuan;

		// Stok Awal
		$this->Stok_Awal = new DbField('v_stok', 'v_stok', 'x_Stok_Awal', 'Stok Awal', '`Stok Awal`', '`Stok Awal`', 3, -1, FALSE, '`Stok Awal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Stok Akhir
		$this->Stok_Akhir = new DbField('v_stok', 'v_stok', 'x_Stok_Akhir', 'Stok Akhir', '`Stok Akhir`', '`Stok Akhir`', 3, -1, FALSE, '`Stok Akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`v_stok`";
	}
	...
	{
		global $Language;
		if ($pageName == "v_stokview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_stokedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_stokadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("v_stokview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_stokview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "v_stokadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_stokadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_stokedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_stokadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_stokdelete.php", $this->getUrlParm());
	}
