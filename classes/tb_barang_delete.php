 ...
 * Page class
 */
class tb_barang_delete extends tb_barang
{
	...
	// Page object name
	public $PageObjName = "tb_barang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("tb_baranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("tb_baranglist.php"); // Return to list
			}
		}
	}
