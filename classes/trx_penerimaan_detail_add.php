 ...
 * Page class
 */
class trx_penerimaan_detail_add extends trx_penerimaan_detail
{
	...
	// Page object name
	public $PageObjName = "trx_penerimaan_detail_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("trx_penerimaan_detaillist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "trx_penerimaan_detaillist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "trx_penerimaan_detailview.php")
