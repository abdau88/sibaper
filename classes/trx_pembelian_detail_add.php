 ...
 * Page class
 */
class trx_pembelian_detail_add extends trx_pembelian_detail
{
	...
	// Page object name
	public $PageObjName = "trx_pembelian_detail_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "trx_pembelian_detailview.php")
	...
	protected function addRow($rsold = NULL)
	{
		...
		// kode_pembelian
		$this->kode_pembelian->setDbValueDef($rsnew, $this->kode_pembelian->CurrentValue, NULL, FALSE);
