 ...
 * Page class
 */
class tb_barang_view extends tb_barang
{
	...
	// Page object name
	public $PageObjName = "tb_barang_view";
	...
	public function __construct()
	{
		...
		if (Get("kode_barang") !== NULL) {
			$this->RecKey["kode_barang"] = Get("kode_barang");
			$keyUrl .= "&amp;kode_barang=" . urlencode($this->RecKey["kode_barang"]);
		}
	...
	public function run()
	{
		...
		if (Get("kode_barang") !== NULL) {
			if ($ExportFileName <> "")
				$ExportFileName .= "_";
			$ExportFileName .= Get("kode_barang");
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("kode_barang") !== NULL) {
				...
				$this->RecKey["kode_barang"] = $this->kode_barang->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->kode_barang->setQueryStringValue(Key(0));
				$this->RecKey["kode_barang"] = $this->kode_barang->QueryStringValue;
			} elseif (Post("kode_barang") !== NULL) {
				$this->kode_barang->setFormValue(Post("kode_barang"));
				$this->RecKey["kode_barang"] = $this->kode_barang->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->kode_barang->setFormValue(Route(2));
				$this->RecKey["kode_barang"] = $this->kode_barang->FormValue;
			} else {
				$returnUrl = "tb_baranglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tb_baranglist.php"; // No matching record, return to list
					}
			}
			...
			$returnUrl = "tb_baranglist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function getExportTag($type, $custom = FALSE)
	{
		...
		if (SameText($type, "excel")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"ew.export(document.ftb_barangview,'" . $this->ExportExcelUrl . "','excel',true);\">" . $Language->phrase("ExportToExcel") . "</a>";
			else
				return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
		} elseif (SameText($type, "word")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"ew.export(document.ftb_barangview,'" . $this->ExportWordUrl . "','word',true);\">" . $Language->phrase("ExportToWord") . "</a>";
			else
				return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
		} elseif (SameText($type, "pdf")) {
			if ($custom)
				return "<a href=\"javascript:void(0);\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"ew.export(document.ftb_barangview,'" . $this->ExportPdfUrl . "','pdf',true);\">" . $Language->phrase("ExportToPDF") . "</a>";
			else
